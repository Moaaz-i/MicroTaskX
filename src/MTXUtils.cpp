...
bool MTXUtils::isButtonLongPressed(uint8_t buttonPin, MTXButton& btnState,
...
uint8_t MTXUtils::calculateBatteryPercentage(uint8_t analogPin, float r1, float r2, float minVolts,
                                             float maxVolts, float vRef, int adcResolution)
{
